...
var bio = {
	...
	"welcomeMessage" : "Hi! I'm Gil, a front end developer based in Brooklyn, NY. " +
										  "I enjoy working in teams, communicating clearly and" +
										  "taking on projects with meaning.",
...
var work = {
	"jobs" : [
		...
		"location" : "New York",
		"dates" : "2003 - Present",
		"description" : "Managed the technical and daily business needs of the" +
										"studio. Implemented an hourly billing solution and other "+
										"solutions to spreadsheet and paper based processes."
		},
		{
		...
		"location" : "New York",
		"dates" : "2002-2003",
		"description" : "Assisted attorneys in the discovery process and the" +
										"management of legal case exhibits of various legal cases."
		},
		{
		...
		"display" : function(){
			for (var i = 0; i<projects.projects.length; i++){
  			...
  			$(".project-entry:last").append(formattedProjectDesc);
				...
				projects.projects[i].images.forEach(function(val){
